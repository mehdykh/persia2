...
<div class='box'>
<h4>Persia core</h4>
<p>Persia core modules.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if($module['isPersiaCore']): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>Persia CMF</h4>
<p>Persia Content Management Framework (CMF) modules.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if($module['isPersiaCMF']): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
...
<h4>
e modules</h4>
<p>Modules that does not implement any specific Persia interface.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if(!($module['isController'] || $module['isPersiaCore'] || $module['isPersiaCMF'])): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
