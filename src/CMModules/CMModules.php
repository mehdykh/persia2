 <?php
/**
 * A model for managing Persia modules.
 * 
 * @package PersiaCore
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $persiaCoreModules = array('CPersia', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $persiaCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isPersiaCore']   = in_array($rc->name, $this->persiaCoreModules);
      $details['isPersiaCMF']    = in_array($rc->name, $this->persiaCMFModules);
