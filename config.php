 ...
 * Define menus.
 *
 * Create hardcoded menus and map them to a theme region through $pe->config['theme'].
 */
$pe->config['menus'] = array(
  'navbar' => array(
 ...
 * Template files can reside in the parent or current theme, the CPersia::ThemeEngineRender()
 ...
 *
 * path: Path to current theme, relativly PERSIA_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
...
$pe->config['theme'] = array(
  ...
  'data' => array(
    ...
    'logo_width' => 32,
    'logo_height' => 32,
    'footer' => '<p>Persia &copy; by Mehdy Khayyami (mehdykh1982@gmail.com)</p>',
  ),
);
